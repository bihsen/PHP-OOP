...
/* 
	...
	*/
	...
	$elf = new Character('Elfs');
	$orc = new Character('Orcs');
	$human = new Character('Humans');

	$sword = new equipment("Sword","Death Sword", 10, 0, 0); // 10 atk bonus, 0 def bonus, 0 life bonus;
	$jewel = new equipment("Necklace","Grace Necklace", 0, 0, 5); // 0 atk bonus, 0 def bonus, 5 life bonus;
	$armur = new equipment("Necklace","Grace Necklace", 0, 0, 5); // 0 atk bonus, 0 def bonus, 5 life bonus;
	 
	$elf->addEquipment($sword);
	$human->addEquipment($jewel);
